...
# Clase servidor con funciones para verificar el canal y el usuario/contraseña
    ...
    def check_auth_password(self, username, password):
        ...
        if username in usernames and password in passwords:
            if usernames.index(username) == passwords.index(password):
                ...
                # Generamos un número aleatorio de 6 dígitos para identificar cada conexión
                connection_ID = random.randint(100000, 999999)
                logging.info("Successful Login - User: %s - Password: %s - ID: %s", username, password, connection_ID)
...
if __name__ == '__main__':
    ...
    try:
        ...
        while True:
            ...
            # Esperamos a que el cliente abra un canal SSH
            ...
            try:
                while True:
                    ...
                    if cmd_from_client != '':
                        # Enviamos el comando al main y él se encargará de devolver la salida al cliente
